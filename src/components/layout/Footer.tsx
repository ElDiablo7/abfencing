    ...
    <footer className="bg-primary-dark text-white/80 pt-16 pb-8">
      <div className="container-max px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:abfencingltd@gmail.com" className="hover:text-white transition-colors">abfencingltd@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/60">
          <p>&copy; {currentYear} AB Fencing Ltd. All rights reserved.</p>
